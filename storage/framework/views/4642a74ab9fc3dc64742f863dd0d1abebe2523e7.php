    ...
    <div class="container-fluid fdfdsf">
        <div class="row sds">
         <div class="col-sm-4 top">
            <a href="<?php echo e(url("user/welcome")); ?>"><img src="<?php echo e(url("public/system/users/img/logo_booking.png")); ?>" style="width: 170px;"></a>
        </div>
...
<header>
    ...
    <nav class="navbar navbar-top-default navbar-expand-lg navbar-simple nav-line">
       <div class="container  news-logo">
        <a href="<?php echo e(url("user/welcome")); ?>">
             <img src="<?php echo e(url("public/system/users/img/logo_booking.png")); ?>" style="width: 100px;">
             <!--Logo Default-->
          </a>
    ...
    <div class="side-menu">
       <div class="inner-wrapper">
          ...
          <nav class="side-nav w-100">
             <ul class="navbar-nav">
                <?php if(empty(session('user')) && empty(session('user')) && empty(session('user'))): ?>                 
                    <li class="nav-item"><a  class="nav-link"  href="<?php echo e(url('/user/login')); ?>"> Login  </a></li>
                    <li class="nav-item" ><a  class="nav-link"  href="<?php echo e(url('user/signup')); ?>">Sign Up </a></li>               
                <?php else: ?>
                    <li class="nav-item"> <a class="nav-link"  href="<?php echo e(url('/actions/logout-user')); ?>">Logout</a></li>
          ...
          <div class="side-footer text-white w-100">
              <img src="<?php echo e(url("public/system/users/img/logo_booking.png")); ?>"  alt="logo" class="logo-dark"> 
          </div>
       </div>
    </div>
                    ...
                    <div class="needextera" style="display: inline-block;width: 100%;">
                        ...
                        <div class="col-xs-4 col-sm-3 col-md-2 nopad text-center">
                          <label class="image-checkbox">
                            <img class="img-responsive" src="<?php echo e(url("public/system/users/img/img/cupboard.png")); ?>" />
                        ...
                        <div class="col-xs-4 col-sm-3 col-md-2 nopad text-center">
                          <label class="image-checkbox">
                            <img class="img-responsive" src="<?php echo e(url("public/system/users/img/img/fridge.png")); ?>"/>
                        ...
                        <div class="col-xs-4 col-sm-3 col-md-2 nopad text-center">
                          <label class="image-checkbox">
                            <img class="img-responsive" src="<?php echo e(url("public/system/users/img/img/oven.png")); ?>"/>
                        ...
                        <div class="col-xs-4 col-sm-3 col-md-2 nopad text-center">
                          <label class="image-checkbox">
                            <img class="img-responsive" src="<?php echo e(url("public/system/users/img/img/laundry.png")); ?>" />
...
<?php /**PATH C:\xampp\htdocs\scrubbing\resources\views/users/booking.blade.php ENDPATH**/ ?>