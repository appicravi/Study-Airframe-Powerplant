...
<header class="main py-4 bg-white mb-5">
   <div class="container">
      <div class="d-flex align-content-center">
         <a href="<?php echo e(url('')); ?>/super-admin/dashboard" class="logo mr-3"><img src="<?php echo e(url('public/system/admin/images/icon/Logos.png')); ?>" class="custom-logo"/></a> 
         <p class="m-0" style="font-size: 16px;"><span class="text-primary"></span></p>
         <div id="mainMenu" class="ml-auto d-flex">
            <div class="dropdown dropdown-hover">
               <div role="button" data-title="Sales">Manage Bookings</div>
            ...
            <div class="dropdown dropdown-hover">
               <div role="button" data-title="Sales">Manage Services</div>
               <div class="dropdown-menu dropdown-menu-right">
              <div class="p-4">
            ...
            <div class="dropdown dropdown-hover">
               <div role="button" data-title="Inventory"><a style="color:#573bc9" href="<?php echo e(url('super-admin/customerlist')); ?>">Manage Customers</a></div>
			</div> 
			<div class="dropdown dropdown-hover">
               <div role="button" data-title="Inventory"><a style="color:#573bc9"  href="<?php echo e(url('super-admin/cleanerlist')); ?>">Manage Cleaners</a></div>
...
</header><?php /**PATH C:\xampp\htdocs\roccabox_app\resources\views/inc/adminHeader.blade.php ENDPATH**/ ?>