...
.self3 i {
    ...
    <body>
   <input type="hidden" id="token" value="<?php echo e(csrf_token()); ?>" name="_token">
    <!-- user login  screen -->
    
    <?php if($assign_status->status!='Pending'): ?><script> location.href="/scrubbing/user/cleaner-info";</script><?php endif; ?>
          ...
          <div class="row">
            <div class="col-md-12 col-12 fxt-bg-color" >
                ...
                <div class="fxt-content">
                   ...
                   <div><h3 class="text-center" style="font-size: 54px;font-weight: 600;">Thank You!</h3></div>
                 <div><h1 class="text-center" style="font-size:19px;font-weight: normal;">Your Booking is Under Review We Will Assign a Cleaner Very Soon</h1></div>
             </div>
          </div>
             </div>
           ...
           $.ajax({ 
               ...
               data:{
                ...
                success: function(response){
                  ...
                  if(obj.status==true){
                    location.href="/"+host+"/user/cleaner-info";
                  }else{
                    // alert(obj.message);
                  }
        }});
...
</html><?php /**PATH C:\xampp\htdocs\scrubbing\resources\views/users/welcome.blade.php ENDPATH**/ ?>