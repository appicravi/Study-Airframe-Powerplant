<html>
    <head>
       ...
       <link href="<?php echo e(url('public/system/users/css/landing.css')); ?>" rel="stylesheet" media="all">
       <script>
 ...
 <div class="container-fluid">
             <div class="row sds">
                <div class="col-sm-4">
                   <a><img src="<?php echo e(url("public/system/users/img/Logo.png")); ?>" style="width: 150px;"></a>
                </div>
                <div class="col-sm-8 custom-df">
                   <div class="menu-bar">
                      <ul class="listed">
                        <a href="<?php echo e(url('/user/login')); ?>"> <li>Login </li></a>
                        <a href="<?php echo e(url('/user/signup')); ?>"> <li><span class="signs">Sign Up</span></li></a>
                   ...
                   <div class="fixed-menu__content">
                      <ul class="mob-menu">
                         <li class="mob-menu__item">
                            <a href="<?php echo e(url('/user/login')); ?>" class="mob-menu__link">login</a>
                         </li>
                         <li class="mob-menu__item">
                            <a href="<?php echo e(url('/user/signup')); ?>" class="mob-menu__link">Sign up</a>
                         </li>
                         <li class="mob-menu__item">
          ...
          <div class="container-fluid">
             <div class="row">
                <div class="col-md-6 col-sm-12  symbosis">
                   <img src="<?php echo e(url("public/system/users/img/banner_leftside.png")); ?>" class="img-fluid"> 
                </div>
                ...
                <div class="col-md-4 text-center">
                   <div class="circligsf">
                      <div class="imgesround">
                         <img src="<?php echo e(url("public/system/users/img/one.png")); ?>">
                      </div>
                ...
                <div class="col-md-4 text-center">
                   <div class="circligsf">
                      <div class="imgesround-2">
                         <img src="<?php echo e(url("public/system/users/img/icon-4.png")); ?>">
                      </div>
                      <div class="hires-head">
                ...
                <div class="col-md-4 text-center">
                   <div class="circligsf">
                      <div class="imgesround-1">
                         <img src="<?php echo e(url("public/system/users/img/three.png")); ?>">           
                      </div>
                      <div class="hires-head">
    ...
    <!-- howit'sworkssection -->
    <div class="section how-it-works" id="working" style="background: <?php echo e(url("public/system/users/img/how_it_works1.png")); ?>;  background-repeat: no-repeat; background-size: cover; background-position: 30% 50%;"  >
       <div class="container">
          ...
          <div class="dfg text-center">
             <img src="<?php echo e(url("public/system/users/img/right-arrow.png")); ?>" alt="">
          </div>
          <div class="fdf text-center">
             <img src="<?php echo e(url("public/system/users/img/line.png")); ?>" alt="">
          </div>
          <div class="row">
                <div class="col-md-4 pb-5">
                   <div class="rectanele text-center ">
                      <div class="icon">
                         <img src="<?php echo e(url("public/system/users/img/icon1.png")); ?>" alt="">
                      </div>
                      <div class="para1">
                ...
                <div class="col-md-4 pb-5">
                   <div class="rectanele text-center ">
                   <div class="icon">
                      <img src="<?php echo e(url("public/system/users/img/icon2.png")); ?>" alt="">
                   </div>
                   <div class="para2">
                      Review guaranteed
                   pricing from local
                ...
                <div class="col-md-4 pb-5">
                   <div class="rectanele text-center ">
                   <div class="icon">
                      <img src="<?php echo e(url("public/system/users/img/icon3.png")); ?>" alt="">
                   </div>
                   <div class="para1">
                      Book and schedule
                      in seconds.
 ...
 </html><?php /**PATH C:\xampp\htdocs\scrubbing\resources\views/users/home.blade.php ENDPATH**/ ?>