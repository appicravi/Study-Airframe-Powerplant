                            ...
                            <div class="col-lg-12">
                                <div class="card">
									<div class="card-header cards" style="background-color: white;">
                                        <strong>Add</strong> Payment Method
                                    </div>
                                        ...
                                        <form action="" id="method" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="name" name="name" placeholder="Enter method name..." class="form-control">
                                                </div>
                                            </div>
													...
													<div>
														<div class="checkbox aut">
															<label for="checkbox1" class="form-check-label ">
																...
																<input type="checkbox" id="auto" name="auto" value="The tray opens automatically" class="form-check-input" style="margin-left: 10px;">
															</label>
														</div>
														<div class="checkbox act">
															<label for="checkbox2" class="form-check-label ">
																Active 
																<input type="checkbox" id="active" name="active" value="Active" class="form-check-input" style="margin-left: 10px;" checked>
															</label>
														</div>
													</div>
                                                </div>
											...
											<div class="row card-footer">
												...
												<input type="hidden" name="type" id="type" value="add_method">
                                                <div class="col-12 col-md-9">
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/paymentMethod/addMethod.blade.php ENDPATH**/ ?>