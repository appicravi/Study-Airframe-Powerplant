                                        ...
                                        <form action="" id="employee" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <!----<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    ...
                                                    <option value="<?php echo e($restaurant->id); ?>" <?php if($restaurant->id==$getEmployee->restaurant_id): ?> selected <?php endif; ?>><?php echo e($restaurant->name); ?></option>
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                   ...
                                                   <option value="">Choose Branch</option>
                                                    ...
                                                    <option value="<?php echo e($branch->id); ?>" <?php if($branch->id==$getEmployee->branch_id): ?> selected <?php endif; ?>><?php echo e($branch->branch_name); ?></option>
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/restaurantAdmin/employees/editEmployee.blade.php ENDPATH**/ ?>