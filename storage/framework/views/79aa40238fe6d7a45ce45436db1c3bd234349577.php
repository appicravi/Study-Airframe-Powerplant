                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="" id="employee" method="post" enctype="multipart/form-data" class="form-horizontal">
                                           ...
                                           <!--- <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label">Choose Restaurant</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <?php $current_resto_id = session('user_id');?>
                                                    <select name="restaurant_id" id="restaurant" class="form-control"  disabled="disabled">
                                                    ...
                                                    <option value="<?php echo e($restaurant->id); ?>" <?php if($restaurant->id==$current_resto_id): ?> selected <?php endif; ?>><?php echo e($restaurant->name); ?></option>                        
...
<?php echo $__env->make('inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/restaurantAdmin/employees/addEmployee.blade.php ENDPATH**/ ?>