                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                     <h5 class="title-5">Category List</h5>
                                      <div role="group" class="btn-group btn-group-sm">
                                          ...
                                          <a href="<?php echo e(url('super-admin/add-category')); ?>" class="btn btn-sm btn-secondary">Add Category</a></div>
                                </div>
                                            ...
                                            <tr class="tr-shadow" id="row_<?php echo e($category['id']); ?>">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a class="item" data-toggle="tooltip" data-placement="top" href="<?php echo e(url('')); ?>/super-admin/edit-category/<?php echo e($category['id']); ?>"><i class="zmdi zmdi-edit"></i></a>
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/dalohotel/resources/views/suparAdmin/AllCategories.blade.php ENDPATH**/ ?>