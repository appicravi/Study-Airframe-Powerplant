                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                     <h5 class="title-5">Type List</h5>
                                      <div role="group" class="btn-group btn-group-sm">
                                          <a href="<?php echo e(url('super-admin/type')); ?>" class="btn btn-sm btn-secondary">Add Type</a></div>
                                </div>
											...
											<tr class="tr-shadow" id="row_<?php echo e($type['id']); ?>" style="border-top: 1px solid #ebe8f8;">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a class="item deleteme" data-id="<?php echo e($type['id']); ?>" data-type="type" data-token="<?php echo e(csrf_token()); ?>" data-toggle="tooltip" data-placement="top" href="javascript:void(0)"><i class="zmdi zmdi-delete"></i></a>
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/dalohotel/resources/views/type/allTypes.blade.php ENDPATH**/ ?>