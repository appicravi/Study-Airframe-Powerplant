                                    ...
                                    <div class="card-body card-block">
                                        <form action="" id="product" method="post" enctype="multipart/form-data" class="form-horizontal">
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="sku" name="sku" placeholder="Enter Product sku..." class="form-control">
                                                </div>
                                            </div>
											<div class="row form-group">
												<div class="col col-md-3">
												...
												<div class="col-12 col-md-9">
													...
													<?php if($modifier): ?>
													<?php $__currentLoopData = $modifier; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<option value="<?php echo e($cat->id); ?>"><?php echo e($cat->name); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
													<?php endif; ?>
													</select>
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/suparAdmin/addProduct.blade.php ENDPATH**/ ?>