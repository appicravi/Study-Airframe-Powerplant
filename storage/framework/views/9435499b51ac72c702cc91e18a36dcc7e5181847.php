...
<tr class="tr-shadow" id="row_<?php echo e($location->id); ?>" style="border-top: 1px solid #ebe8f8;">
        ...
        <td>
            <div class="table-data-feature">
				...
				<a class="item deleteme" data-id="<?php echo e($location->id); ?>" data-type="location" data-token="<?php echo e(csrf_token()); ?>" data-toggle="tooltip" data-placement="top" href="javascript:void(0)"><i class="zmdi zmdi-delete"></i></a>
            </div>
        </td>
    </tr>
