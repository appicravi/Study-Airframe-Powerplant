                                        ...
                                        <form action="" id="cleaner" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="dial_code" name="name" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group" style="">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="password" name='password' id="conf_password"  class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row card-footer">
                                                ...
                                                <input type="hidden" name="type" id="type" value="add_cleaner">
                                                <div class="col-12 col-md-9">
...
<?php echo $__env->make('inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/development/roccabox/resources/views/cleaner/addCleaner.blade.php ENDPATH**/ ?>