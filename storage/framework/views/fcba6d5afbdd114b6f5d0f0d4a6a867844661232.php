                                 ...
                                 <div class="card-header d-flex justify-content-between align-items-center">
                                     <h5 class="title-5">All Restaurant</h5>
                                      <div role="group" class="btn-group btn-group-sm">
                                        <input type="text"  class="form-control"  id="search"  placeholder="Search Restaurant">
                                          ...
                                          <a href="<?php echo e(url('super-admin/add-restaurant')); ?>" class="btn btn-sm btn-secondary">Add new</a></div>
                                </div>
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2 table-earning" id="resto_table">
                                        <thead>
                                            <tr>
                                        ...
                                        <?php if($restaurants): ?>
                                            ...
                                            <tr class="tr-shadow" id="row_<?php echo e($restaurant['id']); ?>">
                                                <!--<tr class="tr-shadow" id="row_9" style="border-top: 1px solid #ebe8f8;-->
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a class="item" data-toggle="tooltip" data-placement="top" href="<?php echo e(url('')); ?>/super-admin/view-restaurant/<?php echo e($restaurant['id']); ?>"><i class="zmdi zmdi-view-list"></i></a>
                                                        <a class="item" data-toggle="tooltip" data-placement="top" href="<?php echo e(url('')); ?>/super-admin/edit-restaurant/<?php echo e($restaurant['id']); ?>"><i class="zmdi zmdi-edit"></i></a>
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/suparAdmin/allRestaurant.blade.php ENDPATH**/ ?>