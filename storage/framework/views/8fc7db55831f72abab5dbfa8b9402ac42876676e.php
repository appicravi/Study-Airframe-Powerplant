								...
								<div class="card-header d-flex justify-content-between align-items-center">
                                     <h5 class="title-5">Product List</h5>
                                      <div role="group" class="btn-group btn-group-sm">
                                          ...
                                          <a href="<?php echo e(url('supar-admin/add-product')); ?>" class="btn btn-sm btn-secondary">Add Product</a></div>
                                </div>
                                           ...
                                           <tr class="tr-shadow" id="row_4" style="border-top: 1px solid #ebe8f8;">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
														<a class="item" data-toggle="tooltip" data-placement="top" href="<?php echo e(url('')); ?>/supar-admin/view-product/<?php echo e($product['id']); ?>"><i class="zmdi zmdi-view-list"></i></a>
                                                        <a class="item" data-toggle="tooltip" data-placement="top" href="<?php echo e(url('')); ?>/supar-admin/edit-product/<?php echo e($product['id']); ?>"><i class="zmdi zmdi-edit"></i></a>
...
<?php /**PATH C:\xampp\htdocs\rcontrol\resources\views/suparAdmin/allProducts.blade.php ENDPATH**/ ?>