                                                ...
                                                <div class="col-12 col-md-9">
                                                    <div class="col-12 col-md-9">
                                                        <div class="checkbox">
                                                            ...
                                                            Blacklist
                                                                <input type="checkbox" id="blacklist" name="blacklist" value="Yes" class="form-check-input" style="margin-left: 10px;">
                                                            </label>
                                                        </div>
                                                </div>
                                                </div>
...
<?php echo $__env->make('inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/dalohotel/resources/views/customer/addCustomer.blade.php ENDPATH**/ ?>