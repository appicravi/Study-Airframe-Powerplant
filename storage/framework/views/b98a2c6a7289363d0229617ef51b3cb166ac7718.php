                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                     <h5 class="title-5">Employees List</h5>
                                      <div role="group" class="btn-group btn-group-sm">
                                          ...
                                          <a href="<?php echo e(url('super-admin/add-employee')); ?>" class="btn btn-sm btn-secondary">Add Employee</a></div>
                                </div>
                                       ...
                                       <tr class="tr-shadow" id="row_4" style="border-top: 1px solid #ebe8f8;">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a class="item" data-toggle="tooltip" data-placement="top" href="<?php echo e(url('')); ?>/super-admin/edit-employee/<?php echo e($employee['id']); ?>"><i class="zmdi zmdi-edit"></i></a>
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/employees/allEmployee.blade.php ENDPATH**/ ?>