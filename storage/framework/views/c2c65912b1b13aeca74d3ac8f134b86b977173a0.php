    ...
    <body>
        <form id="reset">
            <div class="form-group">
                ...
                <input type="password" name="password" class="form-control same" id="input"  placeholder="Enter your new password"
        ...
        <script>
            $(document).ready(function(){
             ...
             jQuery("#reset").validate({
              ...
              messages: {
               password: "Please enter an e-mail address.",
                  },
                  submitHandler: function(form,e) {  
                   ...
                   success:function(response) {      
                       ...
                       if(obj.status==true){
                           ...
                           setTimeout(function(){
                            jQuery('#password').text('Change Password');
...
</html><?php /**PATH C:\xampp\htdocs\scrubbing\resources\views/users/newPassword.blade.php ENDPATH**/ ?>