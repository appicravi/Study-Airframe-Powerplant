...
<header class="main py-4 bg-white mb-2">
   <div class="container">
      <div class="d-flex align-content-center">
         <a href="<?php echo e(url('')); ?>/super-admin/dashboard" class="logo mr-3"><img src="<?php echo e(url('public/system/admin/images/icon/Education.svg')); ?>" class="custom-logo"/></a> 
         <p class="m-0" style="  line-height: 56px; font-size:22px; font-weight:600; "><span class="text-primary"></span><a style = "color: #0c2670;" href="<?php echo e(url('')); ?>/super-admin/dashboard">Study+ Airframe & Powerplant</a></p>
         ...
         <div class="dropdown dropdown-hover">
			...
			<div class="dropdown dropdown-hover">
               <div role="button" data-title="Inventory"><a style="color:#573bc9"  href="<?php echo e(url('question/questionlist')); ?>">Questions</a></div>
...
</header><?php /**PATH C:\xampp\htdocs\education\resources\views/inc/adminHeader.blade.php ENDPATH**/ ?>