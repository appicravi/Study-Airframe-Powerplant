                            ...
                            <div class="col-lg-12">
                                <div class="card">
									<div class="card-header cards" style="background-color: white;">
                                        <strong>Add</strong> Floor Location
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="" id="floor" method="post" enctype="multipart/form-data" class="form-horizontal">
											...
											<div class="row card-footer">
												...
												<input type="hidden" name="type" id="type" value="add_floor">
                                                <div class="col-12 col-md-9">
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/floor/addFloor.blade.php ENDPATH**/ ?>