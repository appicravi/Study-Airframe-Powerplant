                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                     <h5 class="title-5">Roles List</h5>
                                      <div role="group" class="btn-group btn-group-sm">
                                          ...
                                          <a href="<?php echo e(url('super-admin/add-role')); ?>" class="btn btn-sm btn-secondary">Add Role</a></div>
                                </div>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <?php if($role->id!=1 && $role->id!=2 && $role->id!=3 && $role->id!=4): ?>
                                                            <a class="item" data-toggle="tooltip" data-placement="top" href="<?php echo e(url('')); ?>/super-admin/edit-role/<?php echo e($role->id); ?>"><i class="zmdi zmdi-edit"></i></a>
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/roles/allRoles.blade.php ENDPATH**/ ?>