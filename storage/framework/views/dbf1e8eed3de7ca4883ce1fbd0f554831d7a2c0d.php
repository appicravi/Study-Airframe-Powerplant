                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2 table-earning">
                                        ...
                                        <tbody>
                                        <?php echo $__env->make('customer.pagination_data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </tbody>
                                    </table>
                                </div>
                                <!-- END DATA TABLE -->
...
</script><?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/customer/allCustomers.blade.php ENDPATH**/ ?>