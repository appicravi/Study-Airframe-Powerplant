                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                     <h5 class="title-5">Tax List</h5>
                                      <div role="group" class="btn-group btn-group-sm">
									  <input type="text" class="form-control" id="search_service1" placeholder="Search by NAME">
											<input type="hidden" class="form-control" id="crf" value="<?php echo e(csrf_token()); ?>">
                                          <a href="<?php echo e(url('super-admin/add-service')); ?>" class="btn btn-sm btn-secondary">Add Tax</a></div>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\scrubbing\resources\views/service/allTax.blade.php ENDPATH**/ ?>