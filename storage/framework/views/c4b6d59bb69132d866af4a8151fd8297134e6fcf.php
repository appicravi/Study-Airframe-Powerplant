                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <h1 class="title-5 m-b-35">Restaurant Login</h1>
                        </div>
                        <div class="login-form">
                            <form action="" method="post" name="restaurantLogin" id="restaurantLogin">
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/restaurantAdmin/restaurantadminlogin.blade.php ENDPATH**/ ?>