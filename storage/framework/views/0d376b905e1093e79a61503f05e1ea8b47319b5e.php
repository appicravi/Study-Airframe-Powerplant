                                    ...
                                    <div class="card-body card-block">
                                        <form action="" id="edit_branch" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="franchise_name" name="franchise_name" placeholder="Enter franchise name" class="form-control" readonly="readonly" value="<?php echo e($getBranch->franchise_name); ?>">
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="hardware" name="hardware" placeholder="Enter hardware..." class="form-control" value="<?php echo e($getBranch->hardware); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/restaurantAdmin/editBranch.blade.php ENDPATH**/ ?>