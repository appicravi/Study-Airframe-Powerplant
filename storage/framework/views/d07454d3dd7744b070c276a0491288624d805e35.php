							...
							<div class="col-md-12">
								<div class="card-header d-flex justify-content-between align-items-center">
									...
									<div role="group" class="btn-group btn-group-sm">
										...
										<input type="hidden" id="metype" value="room">
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-6">
											<div class="d-flex justify-content-between"><strong>Date</strong>  <span><?php if($order->created_at): ?><?php echo e($order->created_at); ?><?php endif; ?></span>
											</div>
											<hr class="my-1" style="opacity: 0.9;">
										</div>
									</div>
...
<?php /**PATH C:\xampp\htdocs\dalohotel\resources\views/orders/viewRoomBooking.blade.php ENDPATH**/ ?>