                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2 table-earning">
                                        ...
                                        <tbody id="allcust">
                                        <?php if($contactList): ?>
                                                <?php $__currentLoopData = $contactList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="tr-shadow" id="row_<?php echo e($contact['id']); ?>" style="border-top: 1px solid #ebe8f8;">
                                                    ...
                                                    <td>
                                                        <div class="table-data-feature">
                                                           <a class="item deleteme" data-id="<?php echo e($contact['id']); ?>" data-type="cleaner" data-token="<?php echo e(csrf_token()); ?>" data-toggle="tooltip" data-placement="top" href="javascript:void(0)"><i class="zmdi zmdi-delete"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
...
</script><?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/development/roccabox/resources/views/suparAdmin/allContact.blade.php ENDPATH**/ ?>