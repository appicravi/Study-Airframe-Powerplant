                ...
                <form [formGroup]="LoginForm" id="reset">
                   ...
                   <input type="hidden" name="_token" id="token" value="<?php echo e(csrf_token()); ?>">
                      <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control same" id="inputCity"  placeholder="Enter your email"
...
</html><?php /**PATH C:\xampp\htdocs\scrubbing\resources\views/users/Forgetpassword.blade.php ENDPATH**/ ?>