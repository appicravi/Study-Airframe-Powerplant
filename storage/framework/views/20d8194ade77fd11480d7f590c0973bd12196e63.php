                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                     <h5 class="title-5">Halls List</h5>
                                      <div role="group" class="btn-group btn-group-sm">
                                          <a href="<?php echo e(url('super-admin/add-hall')); ?>" class="btn btn-sm btn-secondary">Add Hall</a></div>
                                </div>
                                           ...
                                           <tr class="tr-shadow" id="row_<?php echo e($room['id']); ?>" style="border-top: 1px solid #ebe8f8;">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a class="item" data-toggle="tooltip" data-placement="top" href="<?php echo e(url('')); ?>/super-admin/edit-hall/<?php echo e($room['id']); ?>"><i class="zmdi zmdi-edit"></i></a>
                                                        <a class="item deleteme" data-id="<?php echo e($room['id']); ?>" data-type="hall" data-token="<?php echo e(csrf_token()); ?>" data-toggle="tooltip" data-placement="top" href="javascript:void(0)"><i class="zmdi zmdi-delete"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/dalohotel/resources/views/hallManage/allHalls.blade.php ENDPATH**/ ?>