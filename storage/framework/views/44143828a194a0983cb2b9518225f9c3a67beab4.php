<html>
 ...
 <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <link rel="stylesheet" href="<?php echo e(url("public/system/users/css/style-1.css")); ?>">
    <link rel="preconnect" href="https://fonts.gstatic.com">
          ...
          <div class="row">
            <div class="col-md-5 col-12 fxt-bg-color" >
                ...
                <div class="fxt-content">
                   <div class="fxt-form">
                    <img src="<?php echo e(url("public/system/users/img/Logos.png")); ?>" alt="Logo">
                    <div class="forget-heading"><h3 class="text-left" style="
                        font-size: 20px;
                        margin-top: 25px;
                        margin-bottom: 25px;
                    ">Reset Password</h3>
                    </div>
                <form [formGroup]="LoginForm" id="reset">
                   <div class="">
                   <div class="">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control same" id="inputCity" minlength="6" placeholder="Enter your password"
                            formControlName="password">
                      
                      </div>
                      <div class="form-group">
                        <label for="male">Confirm Password</label>
                        <input type="password" name="password_confirm" class="form-control same" id="inputCity2" minlength="6" placeholder="********"
                           formControlName="password">
                   ...
                   <input type="hidden" name="r_token" id="r_token" value="<?php echo e($token); ?>">
                   <div class="-center">
                      <button type="submit" id="password" class="btn btn-success text-center btn-lg button_one" >Submit</button>
                   </div>
                   <div class="showmst1"></div>
                   
                   <div class="dsdsd" style="text-align: center;">
                      Don't have an account?<a href="<?php echo e(url("/user/signup")); ?>"><span style="color:#35c2ec; font-weight: 400;"> Register here</span></a>
                   </div>
                </div>
             ...
             <div class="col-md-7 col-12 hideform  fxt-bg-img" data-bg-image="img/figure/bg19-l.jpg" style="background-image: url(<?php echo e(url("public/system/users/img/Pattern.png")); ?>);">
                <div class="self3 pointer" >  
               </div>
                <div class="fxt-header">
                   <a href="<?php echo e(url("/user/login")); ?>" class="fxt-logo"><img src="<?php echo e(url("public/system/users/img/fhd.png")); ?>" alt="Logo"></a>
          ...
          messages: {
           password: "Please enter an Password.",
              ...
              submitHandler: function(form,e) {  
               ...
               jQuery.ajax({
               type: 'post',
               url: '/'+host+'/user/password_update',
               cache: false,
               data: formData,
               processData: false,
               contentType: false,
               beforeSend: function() {
                   jQuery('#password').text('Updating ...');
...
</html><?php /**PATH C:\xampp\htdocs\scrubbing\resources\views/users/resetpassword.blade.php ENDPATH**/ ?>