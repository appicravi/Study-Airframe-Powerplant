                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                     <h5 class="title-5">Agents List</h5>
									  ...
									  <input type="text" class="form-control" id="searchcleaner" placeholder="Search by NAME">
                                          ...
                                          <a href="<?php echo e(url('super-admin/add-agent')); ?>" class="btn btn-sm btn-secondary">Add Agents</a></div>
                                </div>
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2 table-earning">
                                        ...
                                        <tbody id="allcust">
                                        <?php if($cleanerList): ?>
                                                <?php $__currentLoopData = $cleanerList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cleaner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="tr-shadow" id="row_<?php echo e($cleaner->id); ?>" style="border-top: 1px solid #ebe8f8;">
                                                    <td><?php echo e($cleaner->id); ?></td>
                                                    <td><?php echo e($cleaner->name); ?></td>
                                                    <td><?php echo e($cleaner->email); ?></td>
                                                    
                                                    <td><?php echo e($cleaner->phone); ?></td>
                                                    <td><a href="#" class="btn btn-secondary">Active</a></td>

                                                    
                                                    <td>
                                                        <div class="table-data-feature">
                                                            <a class="item" data-toggle="tooltip" data-placement="top" href="<?php echo e(url('')); ?>/super-admin/edit-agent/<?php echo e($cleaner->id); ?>"><i class="zmdi zmdi-edit"></i></a>
...
</script><?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/development/roccabox/resources/views/cleaner/allCleaner.blade.php ENDPATH**/ ?>