                                        ...
                                        <form action="" id="coupon" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="name" name="name" placeholder="Enter Coupon name..." class="form-control">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <div class="col-12 col-md-9">
														<div class="checkbox">
															<label for="checkbox1" class="form-check-label ">
															Is Percentage
																<input type="checkbox" id="is_percent" name="is_percent" value="Yes" class="form-check-input" style="margin-left: 10px;">
											...
											<div class="row card-footer">
												...
												<input type="hidden" name="type" id="type" value="add_coupon">
                                                <div class="col-12 col-md-9">
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/coupons/addCoupon.blade.php ENDPATH**/ ?>