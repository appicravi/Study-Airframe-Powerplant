                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                     <h5 class="title-5">Service List</h5>
									  ...
									  <input type="text" class="form-control" id="search_service" placeholder="Search by NAME">
                                          ...
                                          <a href="<?php echo e(url('super-admin/add-service')); ?>" class="btn btn-sm btn-secondary">Add Service</a></div>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\scrubbing\resources\views/service/allService.blade.php ENDPATH**/ ?>