                                    ...
                                    <div class="card-body card-block">
                                        <form action="" id="hall" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
													<input type="number" id="capacity" name="capacity" name="Enter capacity..." class="form-control">
                                                </div>
                                            </div>
											<div class="row form-group">
												<div class="col col-md-3">
											...
											<div class="row card-footer">
												...
												<input type="hidden" name="type" id="type" value="add_hall">
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/dalohotel/resources/views/hallManage/addHall.blade.php ENDPATH**/ ?>