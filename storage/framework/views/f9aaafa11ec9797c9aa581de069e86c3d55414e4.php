      ...
      <div class="d-flex align-content-center">
         ...
         <div id="mainMenu" class="ml-auto d-flex">
            <div class="dropdown dropdown-hover">
              ...
              <div class="p-4">
                 <a href="<?php echo e(url('super-admin/orderlist')); ?>" class="dropdown-item"><i class="fa fa-fw fa-bullseye"></i> Orders</a> 
            ...
            <div class="dropdown dropdown-hover">
              ...
              <div class="p-4">     
                   ...
                   <li><a href="<?php echo e(url('super-admin/all-categories')); ?>" class="dropdown-item"><i class="fa fa-fw fa-check-square"></i> Category</a></li>
                   <li><a href="<?php echo e(url('super-admin/all-products')); ?>" class="dropdown-item"><i class="fa fa-fw fa-check-square"></i> Product Managemet</a></li>
            ...
            <div class="dropdown dropdown-hover">
               ...
               <div class="dropdown-menu dropdown-menu-right">
                  <div class="p-4">
               <a href="<?php echo e(url('super-admin/all-roles')); ?>" class="dropdown-item"><i class="fa fa-fw fa-users"></i> Roles</a> 
               <a href="<?php echo e(url('super-admin/employees')); ?>" class="dropdown-item"><i class="fa fa-fw fa-address-card"></i> Employees
                     </a> <a href="<?php echo e(url('super-admin/taxes')); ?>" class="dropdown-item"><i class="fa fa-fw fa-file-text-o"></i> Taxes
                     </a> <a href="<?php echo e(url('super-admin/floors')); ?>" class="dropdown-item"><i class="fa fa-fw fa-table"></i> Floors
                     </a> <a href="<?php echo e(url('super-admin/methods')); ?>" class="dropdown-item"><i class="fa fa-fw fa-credit-card"></i> Payment Methods
                     </a> <a href="<?php echo e(url('super-admin/zones')); ?>" class="dropdown-item"><i class="fa fa-fw fa-truck"></i> Delivery Zones
                     </a> <a href="<?php echo e(url('super-admin/tags')); ?>" class="dropdown-item"><i class="fa fa-fw fa-tags"></i> Tags
                     </a> <a href="<?php echo e(url('super-admin/branchlist')); ?>" class="dropdown-item"><i class="fa fa-fw fa-sitemap"></i> Branches
                     </a> <a href="<?php echo e(url('super-admin/devicelist')); ?>" class="dropdown-item"><i class="fa fa-fw fa-tablet"></i> Devices
                     </a>
...
</header><?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/inc/adminHeader.blade.php ENDPATH**/ ?>