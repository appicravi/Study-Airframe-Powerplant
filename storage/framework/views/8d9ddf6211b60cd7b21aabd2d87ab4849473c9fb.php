                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="table-data__tool-left">
										...
										<input type="hidden" name="search_type" value="filter_hall">
                                       ...
                                       <tr class="tr-shadow" id="row_<?php echo e($order['id']); ?>" style="border-top: 1px solid #ebe8f8;">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a class="item" data-toggle="tooltip" data-placement="top" href="<?php echo e(url('')); ?>/super-admin/view-hallbooking/<?php echo e($order['id']); ?>"><i class="zmdi zmdi-view-list"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/dalohotel/resources/views/orders/allHallBooking.blade.php ENDPATH**/ ?>