							...
							<div class="col-md-6">
							  ...
							  <div class="col-md-6">
									<div class="card">
										...
										<div class="card-body">
											<a href="<?php echo e(url('')); ?>/super-admin/add-product" class="btn btn-primary">
											<i class="fa fa-magic"></i>&nbsp; Add Item</a>
											<a href="<?php echo e(url('')); ?>/super-admin/edit-product/<?php echo e($productDetail->id); ?>" class="btn btn-primary">
											<i class="fa fa-magic"></i>&nbsp; Edit Item</a>
											<br>
										</div>
									</div>
								</div>
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/dalohotel/resources/views/suparAdmin/viewProduct.blade.php ENDPATH**/ ?>