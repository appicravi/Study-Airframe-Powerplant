                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                     <h5 class="title-5">User List</h5>
									  ...
									  <input type="text" class="form-control" id="searchcust-1" onkeyup="betterFunction()" placeholder="Search by NAME">
                                          ...
                                          <a href="<?php echo e(url('super-admin/add-user')); ?>" class="btn btn-sm btn-secondary">Add User</a></div>
                                </div>
...
<tr class="tr-shadow" id="row_<?php echo e($customert->id); ?>" style="border-top: 1px solid #ebe8f8;">
        ...
        <td><?php echo e($customert->phone); ?></td>
         ...
         <td>
           <input id="status" data-id="<?php echo e($customert->id); ?>" type="checkbox" <?php if($customert->status): ?> checked <?php endif; ?>>        
        </td>
        <td>
            <div class="table-data-feature">
				<a class="item" data-toggle="tooltip" data-placement="top" href="<?php echo e(url('')); ?>/super-admin/edit-user/<?php echo e($customert->id); ?>"><i class="zmdi zmdi-edit"></i></a>
	...
	<?php endif; ?>
                                ...
                                <?php echo e($customertList->links()); ?>
...
</script><?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/development/roccabox/resources/views/customer/allCustomers.blade.php ENDPATH**/ ?>