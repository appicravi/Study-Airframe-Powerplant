...
input:focus:-ms-input-placeholder {
    ...
    <body>
        <?php
        $stripe_key = 'pk_test_51IjKn6SC37oBBROrCjr4dP79xH57UIbDsHcbX4v5xqx79fUFgxJQsDbCAZa59VAbYHe1Xz18iS5oDkGZID8mn4ui00OrHedet6';
    ?>
    <!-- user login  screen -->
    <section class="fxt-template-animation fxt-template-layout19 loaded">
       <div class="container">
          ...
          <div class="card mt-50 mb-50">
            <div class="card-title mx-auto"> checkout </div>
            <div class="nav">
                <ul class="mx-auto">
                    <li class="active"><a href="#">Payment</a></li>
                </ul>
            </div>
            <form action="<?php echo e(route('checkout.payment')); ?>"  method="post" id="payment-form">
                <?php echo csrf_field(); ?>                    
    ...
    <script>
        ...
        const stripe = Stripe('<?php echo e($stripe_key); ?>', { locale: 'en' }); // Create a Stripe client.
    ...
    locale: 'auto'
        ...
        const cardElement = elements.create('card', {iconStyle: 'solid', style: style }); // Create an instance of the card Element.
        ...
        form.addEventListener('submit', function(event) {
            ...
            stripe.confirmCardPayment(clientSecret, {
                ...
                if (result.paymentIntent.status === 'succeeded') {
                      console.log(result);
                     // document.getElementById('plan').value= JSON.stringify(result);
                      form.submit();
                 }
         }
        });
...
</html><?php /**PATH C:\xampp\htdocs\scrubbing\resources\views/checkout/payment.blade.php ENDPATH**/ ?>