            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Recent Enquiries</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                    <div class="table-responsive table-responsive-data2">
                                        <table class="table table-data2 table-earning">
                                            <thead>
                                                <tr>
                                                    <th style="color: #000;">Enquiries ID</th>
                                                    <!-- <th style="color: #000;">Total Amount</th> -->
                                                    <th style="color: #000;">User</th>
                                           ...
                                           <tr class="tr-shadow" id="row_<?php echo e($book['id']); ?>" style="border-top: 1px solid #ebe8f8;">
                                                    ...
                                                    <td>
                                                        <div class="table-data-feature">
                                                            <a class="item" data-toggle="tooltip" data-placement="top" href="#"><i class="zmdi zmdi-view-list"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/development/roccabox/resources/views/suparAdmin/suparadmindash.blade.php ENDPATH**/ ?>