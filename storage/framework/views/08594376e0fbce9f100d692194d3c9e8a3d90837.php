              ...
              <a href="<?php echo e(url('/user')); ?>">
                ...
                <form [formGroup]="LoginForm" id="user_register" >
                   ...
                   <div class="dsdsd" style="text-align: center;">
                     If you already have an account? <a href="<?php echo e(url('/user/login')); ?>"><span style="color:#35c2ec; font-weight: 400;">Log In</span></a>
                   </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\scrubbing\resources\views/users/signup.blade.php ENDPATH**/ ?>