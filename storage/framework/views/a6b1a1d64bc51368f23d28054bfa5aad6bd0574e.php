                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Edit</strong> Hall
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="" id="hall" method="post" enctype="multipart/form-data" class="form-horizontal">
											...
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="email-input" class=" form-control-label">Hall Description</label>
                                                </div>
                                                <div class="col-12 col-md-9">
											...
											<div class="row form-group">
												<div class="col col-md-3">
													<label for="file-input" class="form-control-label">Hall Image</label>
												 </div>
												<div class="col-12 col-md-9">
													<input type="file" id="image" accept="image/x-png,image/gif,image/jpeg" name="image" class="form-control-file">
													<?php if($roomdata): ?>
														<?php if($roomdata->image): ?>
															<img width="100" src="<?php echo e(url('public\system\hall_images')); ?>/<?php echo e($roomdata->image); ?>">
														<?php endif; ?>
													<?php endif; ?>
												</div>
											</div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
												<input type="number" id="capacity" name="capacity" name="Enter capacity..." class="form-control" value="<?php if($roomdata): ?><?php echo e($roomdata->capacity); ?><?php endif; ?>">
                                                </div>
                                            </div>
											<div class="row form-group">
												<div class="col col-md-3">
													<label for="select" class=" form-control-label">Hall Type</label>
												</div>
												<div class="col-12 col-md-9">
											...
											<div class="row form-group">
												<div class="col col-md-3">
													<label for="select" class=" form-control-label">Activate Hall</label>
												</div>
												<div class="col-12 col-md-9">
											...
											<div class="row card-footer">
												...
												<input type="hidden" name="type" id="type" value="edit_hall">
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/dalohotel/resources/views/hallManage/editHall.blade.php ENDPATH**/ ?>