                                        ...
                                        <form action="" id="item" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="item_name" name="item_name" placeholder="Enter Item name..." class="form-control" value="<?php if($getItem->item_name): ?><?php echo e($getItem->item_name); ?><?php endif; ?>">
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="sku" name="sku" placeholder="Enter SKU..." class="form-control" value="<?php if($getItem->sku): ?><?php echo e($getItem->sku); ?><?php endif; ?>">
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="tags" name="tags" placeholder="Enter tags, Comma separated..." class="form-control" value="<?php if($getItem->tags): ?><?php echo e($getItem->tags); ?><?php endif; ?>">
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="purchase_unite" name="purchase_unite" placeholder="Enter Purchase Unit..." class="form-control" value="<?php if($getItem->purchase_unite): ?><?php echo e($getItem->purchase_unite); ?><?php endif; ?>">
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="storage_unite" name="storage_unite" placeholder="Enter Storage Unit..." class="form-control" value="<?php if($getItem->storage_unite): ?><?php echo e($getItem->storage_unite); ?><?php endif; ?>">
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="ingredient_unite" name="ingredient_unite" placeholder="Enter Ingredient Unit..." class="form-control" value="<?php if($getItem->ingredient_unite): ?><?php echo e($getItem->ingredient_unite); ?><?php endif; ?>">
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="p_to_s_fector" name="p_to_s_fector" placeholder="Purchase To Storage Factor..." class="form-control" value="<?php if($getItem->p_to_s_fector): ?><?php echo e($getItem->p_to_s_fector); ?><?php endif; ?>">
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="s_to_p_fector" name="s_to_p_fector" placeholder="Storage To Ingredient Factor..." class="form-control" value="<?php if($getItem->s_to_p_fector): ?><?php echo e($getItem->s_to_p_fector); ?><?php endif; ?>">
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
											...
											<div class="row card-footer">
												...
												<input type="hidden" name="id" id="id" value="<?php if($getItem->id): ?><?php echo e($getItem->id); ?><?php endif; ?>">
...
<?php /**PATH /home/u175865466/domains/appicsoftwares.in/public_html/rcontrol/resources/views/items/editItem.blade.php ENDPATH**/ ?>