       ...
       <div class="container">
          <div class="row">
            <div class="col-md-5 col-12 fxt-bg-color" >
                ...
                <form  id="user_login" method="post" enctype="multipart/form-data">
                   <div class="">
                   <div class="">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control same" id="inputCity"  placeholder="********"
                   ...
                   <div class="-center">
                      <button type="submit" id="login" class="btn btn-success text-center btn-lg button_one" >Log In</button>
                   </div>
                   <div class="showmst1"></div>
                   <div class="form-group pointer" style="text-align: end; color: #35c2ec;" >
                  <a href="<?php echo e(url("action/password_reset")); ?>">  <p>Forgot Password ?</p></a>
                    </div>
             ...
             <div class="col-md-7 col-12 hideform  fxt-bg-img" data-bg-image="<?php echo e(url("public/system/users/img/figure/bg19-l.jpg")); ?>" style="background-image: url(<?php echo e(url("public/system/users/img/Pattern.png")); ?>);">
            ...
            var formData= new FormData(jQuery('#user_login')[0]);
              ...
              success:function(response) {      
                  ...
                  if(obj.status==true){
                    ...
                    jQuery('#login').text('Login Succesfully!');
                    jQuery('.showmst1').css('display','block').html(obj.message);                     
                      setTimeout(function(){
                      //  jQuery('#register').text('Save');
                      //  jQuery('#register').removeAttr('disabled');
                      //  jQuery('.showmst1').css('display','none').html('');                    
                      document.location.href= '/'+host+'/checkout';
                       
                      }, 2000);                    
                      jQuery('#reset').trigger('click');

                  }
                  else if(obj.status=='cleaner'){
                    jQuery('#login').text('Login Succesfully!');
                    jQuery('.showmst1').css('display','block').html(obj.message);                     
                      setTimeout(function(){
                      //  jQuery('#register').text('Save');
                      //  jQuery('#register').removeAttr('disabled');
                      //  jQuery('.showmst1').css('display','none').html('');                    
                      document.location.href= '/'+host+'/user/cleaner-info';
                       
                      }, 2000);
                    
                      jQuery('#reset').trigger('click');

                  }else if(obj.status=='welcome'){
                    jQuery('#login').text('Login Succesfully!');
                    jQuery('.showmst1').css('display','block').html(obj.message);                     
                      setTimeout(function(){
                      //  jQuery('#register').text('Save');
                      //  jQuery('#register').removeAttr('disabled');
                      //  jQuery('.showmst1').css('display','none').html('');                    
                      document.location.href= '/'+host+'/user/welcome';
...
</html><?php /**PATH C:\xampp\htdocs\scrubbing\resources\views/users/login.blade.php ENDPATH**/ ?>