<html>
 ...
 <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <link rel="stylesheet" href="{{ url("public/system/users/css/style-1.css") }}">
    <link rel="preconnect" href="https://fonts.gstatic.com">
          ...
          <div class="row">
            <div class="col-md-5 col-12 fxt-bg-color" >
                ...
                <form [formGroup]="LoginForm" id="reset">
                   ...
                   <input type="hidden" name="r_token" id="r_token" value="{{ $token }}">
                   <div class="-center">
                   ...
                   <div class="dsdsd" style="text-align: center;">
                      Don't have an account?<a href="{{ url("/user/signup") }}"><span style="color:#35c2ec; font-weight: 400;"> Register here</span></a>
                   </div>
                </div>
             ...
             <div class="col-md-7 col-12 hideform  fxt-bg-img" data-bg-image="img/figure/bg19-l.jpg" style="background-image: url({{url("public/system/users/img/Pattern.png")}});">
