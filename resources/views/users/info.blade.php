...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,500;1,600&display=swap" rel="stylesheet">
    <link href="{{url('public/system/users/css/style.css')}}" rel="stylesheet" media="all">
    <link rel="preconnect" href="https://fonts.gstatic.com">
  ...
  <body>
      ...
      <header>
          <div class="container2">
              ...
              <a class="">
                  <img src="{{ url("public/system/users/img/Logos.png") }}" class="scrub-img">
              </a>
              <div class="btn-one">
      ...
      <div class="header1">
        ...
        <span><i class="fa fa-calendar" aria-hidden="true"></i>&nbsp; Subscription : 1 @if($bookings_details->subs=='onetime')Time @else Month @endif</span> 
          <span><i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp; Frequency : {{ $bookings_details->how_often }}</span> 
          <span class="dsescf"><i class="fas fa-broom"></i>&nbsp; Remaining Cleanings : {{ $booking->clean }}</span> 
        </div>
      </div>
      </div>
            ...
            <div class="row">
              <div class="col-md-7 col-sm-12 dds">
                <div class="media row">
                  ...
                  <img class="col-sm-2 p-5 p-sm-0 " src="{{ url('public/images/'.$cleaner->image) }}" alt="Generic placeholder image" width="230">
                  <div class="col-sm-12 media-body">
                      <div class="cleaners">
                        <h5>Meet your Cleaner</h5>
                      </div>
                      <p class="eva">@if($cleaner->first_name){{{ $cleaner->first_name." ".$cleaner->last_name }}}@endif
                       @if(floor($avg)==1) <span><i class="fa fa-star" aria-hidden="true"></i></span>
                       @elseif(floor($avg)==2) <span><i class="fa fa-star" aria-hidden="true"></i></span><span><i class="fa fa-star" aria-hidden="true"></i></span>
                        @elseif(floor($avg)==3)<span><i class="fa fa-star" aria-hidden="true"></i></span><span><i class="fa fa-star" aria-hidden="true"></i></span><span><i class="fa fa-star" aria-hidden="true"></i></span>
                        @elseif(floor($avg)==4)<span><i class="fa fa-star" aria-hidden="true"></i></span><span><i class="fa fa-star" aria-hidden="true"></i></span><span><i class="fa fa-star" aria-hidden="true"></i></span><span><i class="fa fa-star" aria-hidden="true"></i></span>
                        @elseif(floor($avg)==5)<span><i class="fa fa-star" aria-hidden="true"></i></span><span><i class="fa fa-star" aria-hidden="true"></i></span><span><i class="fa fa-star" aria-hidden="true"></i></span><span><i class="fa fa-star" aria-hidden="true"></i></span><span><i class="fa fa-star" aria-hidden="true"></i></span>
                        @endif
                  ...
                  <p class="checks1">{{ $cleaner->description }}</p>
                  <div class="btns-ones">
                      <button type="button" class="btn1" data-toggle="modal" data-target="#myModal">Leave a Review</button>
                      <input type="hidden" id="book" name="book" value="{{ $assign->booking_id }}">
                      <input type="hidden" id="cl_id" name="cl_id" value="{{ $cleaner->id }}">
                      <input type="hidden" id="_token" name="_token" value="{{ csrf_token() }}">
                      <input type="hidden" id="cust" name="cust" value="{{ session('user') }}">
                      @if($status!='Pending')<button type="button" id="change" class="btn2">Select new Cleaner</button>
                      @else<button type="button" id="change" class="btn2" disabled>Request Sent</button>
                      @endif
              ...
              <input type="hidden" id="schedule" value="{{ $booking_schedule->date}}">
              <div class="col-md-5 col-sm-12">

                    <table summary="a calendar"> 
                      <caption>
                        <a href="#" rel="prev"></a>Next Cleaning : {{ date('M d, Y', strtotime($booking_schedule->date)) }} <a href="#" rel="next"></a>
                      </caption>
                  ...
                  <div class="btns-one">
                     @if($status_resh=="Pending") <button type="button" class="btn11" data-toggle="modal" data-target="#myModal1" disabled>Reschedule Sent</button> @else <button type="button" class="btn11" data-toggle="modal" data-target="#myModal1">Reschedule</button> @endif
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="reschedule" method="post">
                    ...
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" name="booking_id" value="{{ $assign->booking_id }}">
                    <div class="row">
                        <div class="col-md-12 text-center">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-heading text-center">
                        ...
                        {{-- <div class="title-description">Join our newsletter and get news in your inbox every week!</div>
                     --}}
                    </div>
                    {{-- <div class="row">
                      <div class="col-md-12">
                  ...
                  {{-- <div class="row">
                    <div class="col-md-6 text-center">
                      <div>
                        ...
                        <label>Chefs' Kitchen</label>
                    </div>
                    <div>
                        <input type="checkbox" name="checkbox1">
                        <label>Healing Flavors</label>
                    </div>
                    <div>
                        <input type="checkbox" name="checkbox1" checked="">
                        <label>Checked Option</label>
                    </div>
                    <div>
                ...
                <div class="row">
                  <div class="col-md-12 text-center">
                     <a href="{{ url('/booking') }}"><button class="modern-button modern-red">Change Subscription</button>
                     </a>
                    </div>
              </div>
                <div class="row">
